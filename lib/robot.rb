class Robot
  ...
  ##
  # Turn the robot face 90 degrees LEFT
  #
  def turn_left
  ...
  ##
  # Turns the robot face 90 degrees RIGHT
  #
  def turn_right
    return false if @direction.nil?
  ...
  ##
  # Parses and executes a string command.
  #
  # TODO: Convert it to a TTY command execution
  def execute(input)
